...
mod1_default_lmer <- lmer (yield_kgha ~ 
                             krate_kgha*nrate_kgha*fdap+ (1 |block/krate_kgha/nrate_kgha),
                           data= rm_rcbd_df)
...
```{r}
mod1_default <- lme (yield_kgha ~ 
                             krate_kgha*nrate_kgha*fdap, random = ~ 1 |block/krate_kgha/nrate_kgha,
                           data= rm_rcbd_df)
